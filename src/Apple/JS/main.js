(() => {
  ...
  function setCanvasImages() {
    ...
    for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
      imgElem2 = new Image(); //document.createElement('img') 와 동일
  ...
  function setLayout() {
    //각 스크롤 섹션의 높이 setting
    for (const section of sceneInfo) {
      if (section.type === "sticky") {
        section.scrollHeight = section.heightNum * window.innerHeight;
      } else if (section.type === "normal") {
        section.scrollHeight = section.objs.container.offsetHeight;
      }
      section.objs.container.style.height = `${section.scrollHeight}px`;
    }
  ...
  function playAnimation() {
    ...
    switch (currentScene) {
      ...
      case 2:
        ...
        //body.offsetWidth = innerWidth에서 스크롤바크기 뺸것
      ...
      let step = 0;
        ...
        if(widthRatio <= heightRatio) {
         ...
         if(!values.rectStartY) {
           ...
           /*offsetTop: 부모의 포지션이 realative인 곳이 맨 꼭대기 기준*/
